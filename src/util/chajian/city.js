...
export default class Craftsman_Settled extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            cities: ['成都'],
            counties: ['成都市', '崇州', '大邑', '都江堰', '金堂', '彭州', '郫县', '蒲江', '邛崃', '双流', '新津']
        }
    }
    //省市区三级联动
    getCity(province) {
        ...
        return (
           <div>
               <div className="city">
                                        ...
                                        <select className="select myprovince" onClick={this.handleChange.bind(this, "province")} style={{border:"none"}} >
                                            {this.state.provinces.map(province => (
                                                <option value={province} key={id++}>{province}</option>
                                            ))}
                                        </select>
                                        <select className="select mycity" onClick={this.handleChange.bind(this, "city")} style={{border:"none"}} >
                                            {this.state.cities.map(city => (
                                                <option value={city} key={id++}>{city}</option>
                                            ))}
                                        </select>
                                        <select className="select mycounty" onClick={this.handleChange.bind(this, "county")} style={{border:"none"}}>
