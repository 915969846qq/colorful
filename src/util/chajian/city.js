  ...
  render() {
    ...
    return (
      <div>
        <div className="city">
          <select
            className="select myprovince"
            onClick={this.handleChange.bind(this, 'province')}
            style={{ border: 'none' }}
          >
            {this.state.provinces.map((province) => (
              <option value={province} key={id++}>
                {province}
              </option>
            ))}
          </select>
          <select
            className="select mycity"
            onClick={this.handleChange.bind(this, 'city')}
            style={{ border: 'none' }}
          >
          ...
          <select
            className="select mycounty"
            onClick={this.handleChange.bind(this, 'county')}
            style={{ border: 'none' }}
          >
            {this.state.counties.map((county) => (
              <option value={county} key={id++}>
                {county}
              </option>
            ))}
          </select>
