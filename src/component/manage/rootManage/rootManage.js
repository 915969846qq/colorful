          ...
          return (
            <p className="state butone">
              ...
              >
                <div>
                  <div className="bj">
                    <div className="sp">工号：</div>
                    <input
                      ref={(input) => (this.a = input)}
                      defaultValue={this.state.inputvlue.avatar}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj">
                    {' '}
                    <div className="sp">手机号：</div>
                    <input
                      ref={(input) => (this.b = input)}
                      defaultValue={this.state.inputvlue.phoneNumber}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj1">
                    <div className="sp">账号：</div>
                    <input
                      ref={(input) => (this.c = input)}
                      defaultValue={this.state.inputvlue.jobNumber}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj1">
                    <div className="sp">密码：</div>
                    <input
                      ref={(input) => (this.d = input)}
                      defaultValue={this.state.inputvlue.password}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj1">
                    <div className="sp">姓名：</div>
                    <input
                      ref={(input) => (this.e = input)}
                      defaultValue={this.state.inputvlue.name}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj1">
                    <div className="sp">身份证：</div>
                    <input
                      ref={(input) => (this.f = input)}
                      defaultValue={this.state.inputvlue.idCard}
                      className="xutaoip"
                    />
                  </div>
                  <div className="bj1">
                    <div className="sp">权限：</div>
                    <input
                      ref={(input) => (this.g = input)}
                      defaultValue={this.state.inputvlue.power}
                      className="xutaoip"
                    />
                  </div>

                  <div className="bj2">
                    <div className="sp2">上传图片：</div>
                    <Upload
                      name="avatar"
      ...
      <div className="wodext">
        ...
        >
          <div>
            <div className="bj">
              <div className="sp">工号：</div>
              <input ref={(input) => (this.gh = input)} className="xutaoip" />
            </div>
            <div className="bj">
              {' '}
              <div className="sp">手机号：</div>
            ...
            <div className="bj1">
              <div className="sp">账号：</div>
              <input ref={(input) => (this.zh = input)} className="xutaoip" />
            </div>
            <div className="bj1">
              <div className="sp">密码：</div>
              <input ref={(input) => (this.pwd = input)} className="xutaoip" />
            </div>
            <div className="bj1">
              <div className="sp">姓名：</div>
              <input ref={(input) => (this.name = input)} className="xutaoip" />
            </div>
            <div className="bj1">
              <div className="sp">身份证：</div>
              <input ref={(input) => (this.id = input)} className="xutaoip" />
            </div>
            <div className="bj1">
              <div className="sp">权限：</div>
              <input ref={(input) => (this.qx = input)} className="xutaoip" />
            </div>
