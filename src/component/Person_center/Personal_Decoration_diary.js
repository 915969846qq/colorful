        ...
        <div className="diary-content">
          <div className="diary-content-header">
            <div className="diary-content-header-left">
              ...
              <p>创建时间：{this.state.diary[0].createdDate}&nbsp;&nbsp;更新时间：{this.state.diary[0].updateDate}</p>
            </div>
          ...
          <div className="diary-content-content">
            <div>
              <p>房屋信息：<input type="text" style={{ lineHeight: "25px" }} disabled={this.state.flag[0]} defaultValue={this.state.diary[0].houseInfo.style} /> </p>
              <p>所在小区：<input type="text" disabled={this.state.flag[0]} defaultValue={this.state.diary[0].houseInfo.community} /></p>
              <p>装修公司：<input type="text" disabled={this.state.flag[0]} defaultValue={this.state.diary[0].houseInfo.decorationCompany}></input></p>
            </div>
        ...
        <div className="diary-content">
          <div className="diary-content-header">
            <div className="diary-content-header-left">
              ...
              <p>创建时间：{this.state.diary[1].createdDate}&nbsp;&nbsp;更新时间：{this.state.diary[1].updateDate}</p>
            </div>
            <div className="diary-content-header-right">
              <div>
                <img src={require('../../assets/images/Collection_icon_03.png')} alt="icon03"></img>
          ...
          <div className="diary-content-content">
            <div>
              <p>房屋信息：<input type="text" style={{ lineHeight: "25px" }} disabled={this.state.flag[1]} defaultValue={this.state.diary[1].houseInfo.style} /> </p>
              <p>所在小区：<input type="text" disabled={this.state.flag[1]} defaultValue={this.state.diary[1].houseInfo.community} /></p>
              <p>装修公司：<input type="text" disabled={this.state.flag[1]} defaultValue={this.state.diary[1].houseInfo.decorationCompany}></input></p>
            </div>
            {this.state.flag[1] === true ? <span onClick={this.check.bind(this, 1)}>编辑</span> : <span onClick={this.save.bind(this, 1)}>保存</span>}
          </div>
          <div className="diary-content-footer">
            <h2>全部日记{this.state.diary.length}篇</h2>
            <span>续写日记</span>
