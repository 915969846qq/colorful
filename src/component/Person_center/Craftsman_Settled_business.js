        ...
        <div className="header-top">
          <Row>
            ...
            <Col span={22}>
              ...
              <div id="addresspp" className="addresspp">
                成都
              </div>
              <div className="readssswitch">
                <a
                  href="1"
                  tjjj="top.cities.list"
                  title="切换城市"
                  rel="nofollow"
                  className="qh"
                >
                ...
                <div className="welcome">
                  您好，欢迎您访问{' '}
                  <a href="1" className="welcome_index">
                    {' '}
                    Colorful
                  </a>{' '}
                  !
              ...
              <div className="top_maina">
                <span className="text">填写个人信息 </span>
                <span className="text2">*为必填项</span>
              </div>

              <div className="contract">
                <p className="dtatle">
                  成都科乐福科技股份有限公司家装电子商务服务平台应用服务合同
                </p>
              </div>
