      ...
      <div className="ordert-content">
        ...
        <div className="ordert-content-content-receiving">
          ...
          <div className="ordert-content-content-receiving-content">
            <div>
              <input type="radio" />
              <span onClick={() => this.add()}>使用新收货地址</span>
            </div>
            <div>
              <label>收 货 &nbsp;人：</label>
              <input
            ...
            <div>
              <label>详细地址：</label>
              <input defaultValue={this.state.consigneeinfo.address}></input>
            </div>
            <div>
              <label>手机号码：</label>
              <input defaultValue={this.state.consigneeinfo.tel}></input>
              <label>固定电话：</label>
              <input defaultValue={this.state.consigneeinfo.Landline}></input>
            </div>
