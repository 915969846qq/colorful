            ...
            body:JSON.stringify({
              ...
              console.log(data);                  
                ...
                if(this.state.login.status==="200"){
                    let login = {"id":this.state.login.data.id,"user":this.state.login.data.phoneNumber}
        ...
        <div className="Sign_in-main">
            ...
            <div className="right Register_login">
                ...
                <form action="" method="post"> 
                    <input type="text" name="phoneNumber" id="phoneNumber" placeholder="请输入您的账号" onBlur={this.phoneNumber.bind(this)}/>
                    <div id="msg1"></div>
                    <input id="password1" type="password" id="password" name="password" placeholder="请输入您的密码" onBlur={this.password.bind(this)}/>
                    <div id="msg2"></div>
                    <div className="clear"> </div>
                    <input id="checkbox" type="checkbox" value=""/>    
                    <p id="read">下次自动登录</p>        
                    <button type="button"  className="den_lu" onClick={this.user.bind(this)}>登录</button>       
                </form>
            </div>
        </div>
    </div>      
