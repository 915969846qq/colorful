...
import Personal_My_order

  from '../component/Person_center/Personal_My_order'
        ...
        <Header>
          <div className="header-top">
            <div className="header-left header">
              ...
              <span className="hover-red" onClick={this.chooseLocal.bind(this)}>【切换】</span>
            </div>
            ...
            <Router basename="/Person">
              <div className="person-content-flex">   
                <Sider className="left-menu">
                  <ul>
                    <li><h3>个人中心</h3></li>
                    <li><NavLink to="/Personal_My_order">我的订单</NavLink></li>
                    <li><NavLink to="/Personal_Decoration_order">装修订单</NavLink></li>
                    <li><NavLink to="/MyCenter_index">个人订单</NavLink></li>
                    <li><NavLink to="/Personal_My_reservation">我的预约</NavLink></li>
                    <li><NavLink to="/Personal_Collection_goods">收藏的商品</NavLink></li>
                    <li><NavLink to="/Personal_A_collection_shops">收藏的店铺</NavLink></li>
                    <li><NavLink to="/Personal_Collection_activities">收藏的活动</NavLink></li>
                    <li><NavLink to="/Personal_My_shopping_cart">我的购物车</NavLink></li>
                    <li><NavLink to="/Personal_customer_service">客户服务</NavLink></li>
                    <li><NavLink to="/Personal_Review_sheet">评论晒单</NavLink></li>
                    <li><NavLink to="/Personal_coupon">优惠券</NavLink></li>
                    <li><NavLink to="/Personal_second_hand_management">我的二手管理</NavLink></li>
                    <li><NavLink to="/Personal_My_service">我的服务</NavLink></li>
                    <li><h3>账户管理</h3></li>
                    <li><NavLink to="/Personal_personal_information">我的个人资料</NavLink></li>
                    <li><NavLink to="/Personal_Receipt_address">收货地址</NavLink></li>
                    <li><NavLink to="/Personal_Security_Center">安全中心</NavLink></li>
                    <li><h3>我的装修</h3></li>
                    <li><NavLink to="/Personal_Decoration_diary">装修日记</NavLink></li>
                    <li><NavLink to="/Personal_Service_role_entry">服务角色入口</NavLink></li>
                  </ul>
                ...
                <Content className="content-content" >
                  <div>
                    ...
                    <Route path="/MyCenter_index" component={MyCenter_index}></Route>
                    ...
                    <Route path="/Personal_second_hand_management" component={Personal_second_hand_management}></Route>
                    <Route path="/Personal_My_service" component={Personal_My_service}></Route>
                    <Route path="/Personal_personal_information" component={Personal_personal_information}></Route>
                    <Route path="/Personal_Receipt_address" component={Personal_Receipt_address}></Route>
                    <Route path="/Personal_Security_Center" component={Personal_Security_Center}></Route>
                    <Route path="/Personal_Decoration_diary" component={Personal_Decoration_diary}></Route>
                    <Route path="/Personal_Service_role_entry" component={Personal_Service_role_entry}></Route>
