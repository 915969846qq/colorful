      ...
      <Layout style={{ minHeight: '100vh' }}>
        <Sider collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
          ...
          <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
            ...
            <Menu.Item key="/manage/RootManage" onClick={this.go} icon={<DesktopOutlined />}>
              权限管理
            </Menu.Item>
            <Menu.Item key="/manage/SearchManage" onClick={this.go} icon={<DesktopOutlined />}>
              订单管理
            </Menu.Item>
            <SubMenu key="/manage/UsersStatistics" title="用户统计" icon={<DesktopOutlined />}>
              <Menu.Item key="/manage/UsersStatistics" onClick={this.go} icon={<DesktopOutlined />}>
                消费者统计
              </Menu.Item>
              <Menu.Item key="/manage/MerchantStatistics" onClick={this.go} icon={<DesktopOutlined />}>
                商户统计
              </Menu.Item>
            </SubMenu>
            <SubMenu key="/manage/Usersaudit" title="用户审核" icon={<DesktopOutlined />}>
              <Menu.Item key="/manage/Usersaudit" onClick={this.go} icon={<DesktopOutlined />}>
                未审核用户
              </Menu.Item>
              <Menu.Item key="/manage/Usersaudited" onClick={this.go} icon={<DesktopOutlined />}>
                已审核用户
              </Menu.Item>
            </SubMenu>
